...
import NearbyContainer from '@/app/components/nearby/NearbyContainer'
...
export default function MapPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      <TopNavigation activeTab="nearby" onTabChange={handleTabChange} />
      
      <main className="flex-1 overflow-hidden pt-0 pb-20">
        <NearbyContainer 
          sessionId={sessionId}
